...
class WikimediaVipsHttpsLoaderTest(WikimediaTestCase):
    ...
    def test_tiff(self):
        self.run_and_check_ssim_and_size(
            url='/thumbor/unsafe/400x/filters:format(jpg)/https://upload.wikimedia.org/wikipedia/commons/0/0e/0729.tiff',
    ...
    def test_multipage_tiff(self):
        self.run_and_check_ssim_and_size(
            url='/thumbor/unsafe/400x/filters:format(jpg):page(3)/https://upload.wikimedia.org/wikipedia/commons/2/28/International_Convention_for_Regulation_of_Whaling.tiff',
    ...
    def test_multipage_tiff_without_page_filter(self):
        self.run_and_check_ssim_and_size(
            url='/thumbor/unsafe/400x/filters:format(jpg)/https://upload.wikimedia.org/wikipedia/commons/2/28/International_Convention_for_Regulation_of_Whaling.tiff',
    ...
    def test_multipage_tiff_with_out_of_bounds_page(self):
        self.run_and_check_ssim_and_size(
            url='/thumbor/unsafe/400x/filters:format(jpg):page(500)/https://upload.wikimedia.org/wikipedia/commons/2/28/International_Convention_for_Regulation_of_Whaling.tiff',
            mediawiki_reference_thumbnail='lossy-page1-400px-International_Convention_for_Regulation_of_Whaling.tiff.jpg',
            perfect_reference_thumbnail='lossy-page1-400px-International_Convention_for_Regulation_of_Whaling.tiff.png',
            expected_width=400,
            expected_height=566,
    ...
    def test_png(self):
        self.run_and_check_ssim_and_size(
            url='/thumbor/unsafe/400x/https://upload.wikimedia.org/wikipedia/commons/c/cf/WorldMap-A_non-Frame.png',
